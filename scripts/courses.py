...
def main():
    departments = ["PSYCH", "PUB AFF", "PUB HLT", "PUB PLC", "RELIGN", "ROMANIA", "RUSSN", "SCAND", "SCI EDU", "SEMITIC", "SRB CRO", "SLAVC", "SOC SC", "SOC WLF", "SOC GEN", "SOCIOL", "S ASIAN", "SEASIAN", "SPAN", "STATS", "SWAHILI", "THAI", "THEATER", "TURKIC", "UKRN", "UNIV ST", "URBN PL", "VIETMSE", "WL ARTS", "YIDDSH"]
